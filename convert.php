<?php
	...
	*/
	...
	$file_path=$_SERVER['DOCUMENT_ROOT'].'/pdf2html/pdftohtml.exe -c -i '.$file_name; // Vamos a la ruta donde esta ubicado el ejecutable del pdftohtml y escribimos el comando que ejecutaremos en consola en la siguiente línia.
